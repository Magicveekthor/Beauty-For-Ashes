...
<html lang="en">
    ...
    <title> Message Sent || Beauty For Ashes</title>
    <!-- favicons Icons -->
...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="error-page__inner">
                            <i class="fa-regular fa-circle-check error-page__title"></i>
                            <h3 class="error-page__tagline"><i>MESSAGE SENT!</i>
                            </h3>
                            <p class="error-page__text">Our team would get back to you as soon as possible.</p>
                            <a href="../index.html" class="thm-btn error-page__btn mt-5">back to home</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="assets/images/resources/logo.png" alt="" /></a>
            </div>
            <!-- /.logo-box -->
