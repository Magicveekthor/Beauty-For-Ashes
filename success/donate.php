...
<html lang="en">
    ...
    <title> Donation Successful || Beauty For Ashes</title>
    <!-- favicons Icons -->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="error-page__inner">
                            ...
                            <h3 class="error-page__tagline">Thank you for your donation!
                            </h3>
                            <!-- <p class="error-page__text">The page you are looking for was never existed.</p> -->
                            <a href="index-2.html" class="thm-btn error-page__btn mt-5">back to home</a>
                        </div>
                    </div>
                </div>
            </div>
